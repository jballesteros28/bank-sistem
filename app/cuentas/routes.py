...
def crear_nueva_cuenta(
    ...
    """
    return crear_cuenta(cuenta_datos, usuario_token.id, organizacion.id, db, background_task)
...
def listar_cuentas(
    ...
    """
    return obtener_cuentas_usuario(usuario_token.id, organizacion.id, db)
...
def obtener_cuenta(
    ...
    """
    return obtener_cuenta_por_id(cuenta_id, usuario_token.id, organizacion.id, db)
