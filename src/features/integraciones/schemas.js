...
export const API_KEY_SCOPE_OPTIONS = [
  ...
  { value: "ecommerce:read", label: "Ecommerce lectura", description: "Consultar eventos de compras recibidas." },
  { value: "ecommerce:write", label: "Ecommerce escritura", description: "Recibir compras pagadas y aplicar recompensas." },
...
export const WEBHOOK_EVENT_OPTIONS = [
  ...
  { value: "ecommerce.order_paid", label: "Orden ecommerce pagada" },
  { value: "ecommerce.order_processed", label: "Orden ecommerce procesada" },
  { value: "ecommerce.order_failed", label: "Orden ecommerce fallida" },
